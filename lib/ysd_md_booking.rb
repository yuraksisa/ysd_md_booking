...
require 'yito/model/classifier/ysd_md_classifier_taxonomy'
require 'yito/model/classifier/ysd_md_classifier_term'
require 'yito/model/booking/concerns/ysd_md_usage'
require 'yito/model/booking/concerns/ysd_md_maintenance'
require 'yito/model/booking/concerns/ysd_md_insurance'
require 'yito/model/booking/concerns/ysd_md_purchasable'
require 'yito/model/booking/concerns/ysd_md_registrable'
require 'yito/model/booking/concerns/ysd_md_booking_customer'
...
require 'yito/model/booking/ysd_md_booking_rental_storage'
...
require 'yito/model/booking/pdf/ysd_md_booking_pickup_return_v2_pdf'
...
require 'yito/model/booking/pdf/ysd_md_booking_contract_pdf'
require 'yito/model/booking/pdf/ysd_md_booking_qrcode_pdf'
...
require 'yito/model/booking/ysd_md_booking_category_classifier_term'
require 'yito/model/booking/ysd_md_booking_category_offer'
require 'yito/model/booking/ysd_md_booking_category_offer_categories'
require 'yito/model/booking/ysd_md_booking_extra'
require 'yito/model/booking/ysd_md_booking_extra_category'
...
require 'yito/model/booking/ysd_md_booking_activity_classifier_term'
