  ...
  module BookingPickupReturn
    def self.included(model)
      if model.respond_to?(:property)
        ...
        model.property :custom_pickup_place, DataMapper::Property::Boolean, default: false
        ...
        model.property :custom_return_place, DataMapper::Property::Boolean, default: false
